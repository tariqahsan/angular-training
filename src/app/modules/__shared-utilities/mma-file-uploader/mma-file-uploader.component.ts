...
@Component({
  selector: 'app-mma-file-uploader',
  templateUrl: './mma-file-uploader.component.html',
  styleUrls: ['./mma-file-uploader.component.scss']
})
export class MMAFileUploaderComponent implements OnInit, OnDestroy {
  ...
  cancelAll(){
    this.global_utilities.scrollToElement('.mma-file-uploader', 100);
    let selected_file_count  = this.selected_files.length;
    for(let i = 0; i < selected_file_count; i++){
